...
#根據結果，路面狀況.路面缺陷可能是影響事故發生次數之原因，以無缺陷為最多，有坑洞次之
...
#根據結果，車道劃分會是影響事故發生次數之原因，以未繪設車道線為最多
...
#根據觀察，當事者事故發生時年齡平均、中位數約落在35-38歲、第一四分位約落在21-24歲、第三四分位約落在50-55歲，事故好發於30-40歲之間，推測是該年齡層上路的機會最高，且外出時間通常恰逢事故好發尖峰期間
...
1. 每項變數是否能得出影響事故發生件數的權重呢？
2. 各項變數之間是否會互相影響？討論類別資料間的相關性可以使用甚麼分析方法
3. 本次專案分析並未考慮當地人口數量及密度，無法得知各地區發生車禍的機率，
   如果可以進一步獲得特定時段、區域的車流量資料，將可以提醒用路人避開事故好發的尖峰期
   並且亦可以向地方政府提出改善道路設計的建議
4. 我們知道數值資料可以藉由迴歸分析等模擬方式產出預測，藉由修正慢慢趨近真實值，
   因此，我也思考是否有特殊的分析方法可以將類別資料轉換成具有統計意義的統計量進行迴歸分析
5. 由於資料呈現連續性質，故若學生於未來學習時間序列分析、縱向分析、文字探勘等技巧，或許可以藉由一系列的    事故資料繪製出事故的趨勢圖，這也是我最為期待的分析結果
